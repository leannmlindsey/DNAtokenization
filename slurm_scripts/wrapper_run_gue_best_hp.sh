...
# Hyena
#LOG_DIR="../watch_folder/gue_cv10/hyena/replicates"
...
#RC_AUGS=( "true" )
#LRS=( "6e-3" "6e-4" "6e-5" )
#CSV_FILE=${CSV_FILE:-"best_hp_hyena_GUE.csv"}
...
#RC_AUGS=( "true" )
#LRS=("1e-4" "2e-4" "5e-5")
#CSV_FILE=${CSV_FILE:-"best_hp_mamba_char_GUE.csv"}
...
LRS=("2e-3" "1e-3")
LRS=("1e-4" "5e-4" "1e-5")
CSV_FILE=${CSV_FILE:-"hp_round3/best_hp_caduceus_GUE.csv"}
...
while IFS=, read -r col1 col2 col3 col4 col5 remainder || [ -n "$col1" ]; do
  ...
  # Set default RC_AUG value (true for all but false on Caduceus-ps)
  RC_AUG=${RC_AUG:-"false"}
