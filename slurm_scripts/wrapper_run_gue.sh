...
# human hg38 tokenizer trained BPE  models
#CONFIG_PATH="/uufs/chpc.utah.edu/common/home/u1323098/sundar-group-space2/PHAGE_FINAL_PAPER/MODELS/TEST_BED/caduceus/outputs/pretrain/hg38/mamba_hg38_human_bpe_ntp_rc_aug_seqlen-4k_d_model-256_n_layer-4_lr-8e-6/model_config.json"
#PRETRAINED_PATH="/uufs/chpc.utah.edu/common/home/u1323098/sundar-group-space2/PHAGE_FINAL_PAPER/MODELS/TEST_BED/caduceus/outputs/pretrain/hg38/mamba_hg38_human_bpe_ntp_rc_aug_seqlen-4k_d_model-256_n_layer-4_lr-8e-6/checkpoints/last.ckpt"
#DISPLAY_NAME="mamba_hg38tokenizer_bpe_4k_d256_4L"
...
## Caduceus Parameter Sharing
#LOG_DIR="../watch_folder/gue_cv10/caduceus"
#CONFIG_PATH=$(realpath "../outputs/pretrain/hg38/caduceus-ps_seqlen-1k_d_model-256_n_layer-4_lr-8e-3/model_config.json")
#PRETRAINED_PATH=$(realpath "../outputs/pretrain/hg38/caduceus-ps_seqlen-1k_d_model-256_n_layer-4_lr-8e-3/checkpoints/last.ckpt")
