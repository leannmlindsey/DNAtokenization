...
do
	...
	max_length=$(get_max_length $data)
        ...
        echo "Training on dataset: $data with max_length: $max_length with model: ${model}"

        python train_orig.py \
            --model_name_or_path ${model} \
            --data_path  ${data_path}/$data \
            --kmer -1 \
            --run_name NTv2__${lr}_${data}_seed${seed} \
            ...
            --fp16 \
            --save_steps 400 \
            --output_dir $output_path/gb_NTv2_${lr}_${data}_seed${seed} \
