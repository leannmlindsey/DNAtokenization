...
output_path="/ocean/projects/bio230026p/lindseyl/TOKENIZATION_FINAL_PAPER/RESULTS/DNABERT"
...
do
	...
	# Get the appropriate max_length for this dataset
        ...
        python train.py \
            ...
            --kmer ${kmer} \
            --run_name DNABERT1_${kmer}_${lr}_${data}_seed${seed} \
            ...
            --fp16 \
            --save_steps 200 \
            --output_dir ${output_path}/dnabert1_${kmer}_${lr}_${data}_seed${seed}\
