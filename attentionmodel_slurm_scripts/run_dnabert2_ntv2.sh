...
output_path="/ocean/projects/bio230026p/lindseyl/TOKENIZATION_FINAL_PAPER/RESULTS/DNABERT2_repeated"
...
do
    ...
    #for data in H4K20me1 enhancers enhancers_types promoter_all promoter_no_tata promoter_tata splice_sites_acceptors splice_sites_all splice_sites_donors
    #for data in H2AFZ H3K27ac H3K27me3 H3K36me3 H3K4me1 H3K4me2 H3K4me3 H3K9ac H3K9me3
    do
        ...
        python train_orig.py \
            ...
            --fp16 \
            --save_steps 200 \
            --output_dir $output_path/DNABERT2_${vocab}_${lr}_${data}_seed${seed} \
