...
From: https://huggingface.co/datasets/InstaDeepAI/nucleotide_transformer_downstream_tasks_revised
"""
...
class NucleotideTransformerDatasetv2(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        # NTv2 changed the format online...had to revise the data loading
        ...
        # Filter for the specific task (dataset_name is now the task name)
        self.seqs = full_dataset.filter(lambda x: x['task'] == dataset_name)
